...
Strings were extracted from the Free module's i18n CSVs in 2026-04-30 during
...
- `verify_url` and `content_hash` template vars are empty in the Free
...
- Translations load alongside the Free CSVs (Magento merges all enabled
  modules' i18n dictionaries before locale fallback runs).
- The Free module's `Plugin\Translate\MergeParentLanguageStrings` plugin
...
All non-en_US CSVs were AI-drafted in the Free phase-10 localization sprint
